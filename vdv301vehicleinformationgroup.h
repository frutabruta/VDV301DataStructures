...
public:
    ...
    bool movingDirectionForward=true; // name="MovingDirectionForward" type="IBIS-IP.boolean" minOccurs="0", Gives information, if the vehicle is moving forward, default value is "true"
    ...
    bool speakerActive=false; // name="SpeakerActive" type="IBIS-IP.boolean" minOccurs="0", Gives information, if the loud speaker is activated for a passenger announcement
    bool stopInformationActive=true; // name="StopInformationActive" type="IBIS-IP.boolean" minOccurs="0", Gives information, if the stopInformation inside the vehicle is in active or in passiv state (intentionally, e.g. due to "route left)
